...
# TODO: ATTENZIONE SISTEMARE EASTER EGG
# unisco i crucchi (Trento e Bolzano) e cancello le due province
unisciCrucchi = function (dataset, anno){
...
PopolazioneResidente = rbind(
                          unisciCrucchi(popolazione_residente_2001, 2001), 
                          unisciCrucchi(popolazione_residente_2011, 2011),
                          unisciCrucchi(popolazione_residente_2021, 2021))